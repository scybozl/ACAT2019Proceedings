...
The cross-section can be computed by setting the correct value of the ratio $\chhh / y_t$ and of the global rescaling factor. For example, $\sigma(y_t=1.2,\chhh=1)=(1.2)^4\,\sigma(y_t=1,\chhh=1/1.2)$. Fig.~\ref{fig:ytvars}  shows the distribution of $m_{hh}$ for extreme values of the top-Higgs Yukawa coupling that are still not experimentally excluded~\cite{Sirunyan:2018sgc}.
