...
Note that since the contributions can be separated in triangle- and box-like diagrams, the top-Higgs Yukawa coupling $y_t$ can easily be varied within the same code by rescaling the monomes in Eq.~(\ref{eq:2ndorder}):
...
\begin{figure}[htb!]
  \centering
    \includegraphics[width=0.65\textwidth]{plots/{NLO_CPP_yt_0.8_1.2_mHH}.pdf}
